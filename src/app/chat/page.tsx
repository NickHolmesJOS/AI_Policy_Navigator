      ...
      <div className="mx-auto w-full max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
        ...
        <div className="mb-8 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-2xl font-bold text-white">Policy Q&amp;A</h1>
              <p className="text-sm text-zinc-400">
                Chat with AI about your policies&mdash;ask questions, get answers
              </p>
            </div>
          </div>
        ...
        <div className="mb-8 grid grid-cols-2 gap-3 sm:grid-cols-3">
          {[
            { label: "Total Policies", val: policies.length, Icon: FileText, cls: "text-zinc-400" },
            { label: "Ready to Chat", val: analyzedPolicies.length, Icon: MessageSquare, cls: "text-blue-400" },
            {
              label: "Messages",
              val: policies.reduce((acc, p) => acc + (p.chatHistory?.length || 0), 0),
              Icon: MessageSquare,
              cls: "text-cyan-400",
            },
          ].map((s) => (
        ...
        {policies.length === 0 ? (
          <div className="flex flex-col items-center justify-center py-24 text-center">
            ...
            <p className="mx-auto mt-2 max-w-sm text-sm text-zinc-400">
              Submit and analyze a policy to start chatting about it.
            </p>
                    ...
                    <button
                      ...
                      className={cn(
                        ...
                        selectedPolicyId === policy.id &&
                          "border-l-2 border-l-blue-500 bg-blue-500/[0.06]"
                      )}
                    >
                      ...
                      <div className="mt-1 flex items-center gap-2">
                        ...
                        {policy.chatHistory && policy.chatHistory.length > 0 && (
                          <span className="text-[11px] text-zinc-500">
                            {policy.chatHistory.length} msgs
                          </span>
                        )}
                      </div>
                    </button>
